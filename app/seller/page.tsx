                ...
                <div className="relative group">
                    <div className="w-24 h-24 rounded-full bg-green-50 border-4 border-white shadow-md overflow-hidden flex items-center justify-center transition-transform group-hover:scale-105 duration-300">
                        {shopImage ? (
                            ...
                            <span className="text-3xl font-black text-[#006837]">{shopName.charAt(0) || 'S'}</span>
                        )}
                    </div>
                ...
                <div>
                    {isEditing ? (
                        <input 
                            ...
                            className="text-2xl md:text-3xl font-black text-gray-900 border-b-2 border-[#006837] focus:outline-none bg-transparent py-1"
            ...
            <div className="flex flex-wrap gap-3 w-full md:w-auto">
                {isEditing ? (
                    <button 
                        ...
                        className="flex-1 md:flex-none bg-[#006837] text-white px-6 py-3.5 rounded-xl font-bold hover:bg-green-800 transition-all flex items-center justify-center gap-2 shadow-lg shadow-green-900/20 active:scale-95"
                    >
                    ...
                    <button 
                        ...
                        className="flex-1 md:flex-none bg-white border border-gray-200 text-gray-700 px-6 py-3.5 rounded-xl font-bold hover:bg-gray-50 hover:border-gray-300 transition-all flex items-center justify-center gap-2 shadow-sm active:scale-95"
                    >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="space-y-3 max-w-2xl">
              ...
              <h2 className="text-2xl md:text-3xl font-black tracking-tight drop-shadow-sm">
                Sistem Pra-Kelayakan Halal JAKIM
              </h2>
              
              <p className="text-green-50 text-sm md:text-base leading-relaxed opacity-95">
                Tingkatkan jualan dan raih kepercayaan pelanggan dengan status Halal. Muat naik dokumen asas anda dan pasukan UMMart akan membimbing anda melengkapkan permohonan MYeHALAL secara percuma.
              </p>
            </div>

            <Link
              href="/seller/halal"
              className="group inline-flex items-center justify-center gap-2 bg-white text-[#006837] px-8 py-4 rounded-xl font-bold shadow-lg shadow-black/10 hover:bg-gray-50 hover:scale-105 active:scale-95 transition-all duration-300 shrink-0 w-full md:w-auto"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 text-gray-500 mb-3">
                    <div className="p-2 bg-green-50 text-[#006837] rounded-lg">
                      <DollarSign size={20} />
                    </div>
                        ...
                        {sellerProducts.length > 0 ? sellerProducts.map((product: Product) => (
                            ...
                            <tr>
                                <td colSpan={5} className="p-12 text-center">
                                  ...
                                  <p className="text-gray-500 mb-6">Start adding products to your store to generate sales.</p>
                                  <Link href="/seller/add" className="inline-flex items-center gap-2 bg-[#006837] text-white px-6 py-3 rounded-xl font-bold hover:bg-green-800 transition">
